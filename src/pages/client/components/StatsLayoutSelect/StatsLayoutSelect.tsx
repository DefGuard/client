...
export const StatsLayoutSelect = () => {
  ...
  const clientLL = LL.pages.client;

  const options = useMemo(
    (): SelectOption<ClientView>[] => [
      { key: 0, value: ClientView.GRID, label: clientLL.header.filters.views.grid() },
      {
        key: 1,
        value: ClientView.DETAIL,
        label: clientLL.header.filters.views.detail(),
      },
    ],
    [clientLL.header.filters.views],
  );
