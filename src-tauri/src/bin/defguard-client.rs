...
use defguard_client::{
    ...
    __cmd__update_instance, __cmd__update_location_routing, __cmd__update_settings, __cmd__save_tunnel,
    __cmd__parse_config,
    appstate::AppState,
    commands::{
        ...
        update_location_routing, update_settings, save_tunnel, parse_config
    },
